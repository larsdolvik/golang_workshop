...
/*
	...
	2. Func to handle our http-request to: https://jsonplaceholder.typicode.com/posts/1/comments
	This Url returnes an array of objects.

	3. A create a struct that matches the data structure of the response from 
	the response gotten from the URL above.
